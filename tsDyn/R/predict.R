...
#' \sQuote{\code{VAR}} or \sQuote{\code{VECM}}
#' 
#' Forecating a non-linear model object of general class \sQuote{\code{nlar}},
#' or a linear multivariate \sQuote{\code{VAR}} / \sQuote{\code{VECM}},
#' including \sQuote{\code{setar}} and \sQuote{\code{star}}.
#' 
#' @aliases predict predict.nlar predict.VAR predict.VECM
#' @param object An object of class \sQuote{\code{nlar}}; generated by
#' \command{setar()} or \command{lstar()}. Alternatively, a multivariate object
#' of class \sQuote{\code{VAR}} or \sQuote{\code{VECM}}
...
#' \code{\link{lstar}}; or \code{\link{lineVar}} and \code{\link{VECM}}.
#' 
